...
wp_interactivity_state('create-block', array('solvedCount' => 0, 'quizName' => 'Impossible'));
...
<div style="background-color: <?php echo $attributes['bgColor']?>" class="interactivity-api-quiz-frontend"
  ...
  <ul>
    ...
    <li data-wp-class--fade-incorrect="callbacks.incorrectFadeClass"
      data-wp-class--no-click="callbacks.correctFadeClass" <?php echo wp_interactivity_data_wp_context($answer) ?>
      data-wp-on--click="actions.guessAttempt">
      <span data-wp-bind--hidden="!context.solved">
        <span data-wp-bind--hidden="!context.correct"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
            viewBox="0 0 16 16">
            <path
